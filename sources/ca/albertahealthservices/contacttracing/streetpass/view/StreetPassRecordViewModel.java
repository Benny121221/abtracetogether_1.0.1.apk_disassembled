...
public final class StreetPassRecordViewModel {
    ...
    public StreetPassRecordViewModel(StreetPassRecord streetPassRecord, int i) {
        ...
        this.f7org = streetPassRecord.getOrg();
    }

    public /* synthetic */ StreetPassRecordViewModel(StreetPassRecord streetPassRecord, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i2 & 2) != 0) {
            i = 1;
        }
        this(streetPassRecord, i);
    }
