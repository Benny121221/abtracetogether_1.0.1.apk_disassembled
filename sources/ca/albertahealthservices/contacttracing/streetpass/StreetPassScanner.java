...
public final class StreetPassScanner {
    ...
    public final class BleScanCallback extends ScanCallback {
        ...
        private final void processScanResult(ScanResult scanResult) {
            ...
            if (scanResult != null) {
                ...
                if (scanRecord != null) {
                    bArr = scanRecord.getManufacturerSpecificData(1023);
                }
                bArr = "N.A".getBytes(Charsets.UTF_8);
                Intrinsics.checkExpressionValueIsNotNull(bArr, "(this as java.lang.String).getBytes(charset)");
                String str = new String(bArr, Charsets.UTF_8);
                ConnectablePeripheral connectablePeripheral = new ConnectablePeripheral(str, num, rssi);
    ...
    static {
        ...
        $$delegatedProperties = new KProperty[]{Reflection.mutableProperty1(new MutablePropertyReference1Impl(Reflection.getOrCreateKotlinClass(cls), "scanner", "getScanner()Lca/albertahealthservices/contacttracing/bluetooth/BLEScanner;")), Reflection.mutableProperty1(new MutablePropertyReference1Impl(Reflection.getOrCreateKotlinClass(cls), "context", "getContext()Landroid/content/Context;"))};
    }
