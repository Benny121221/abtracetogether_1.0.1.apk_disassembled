    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof ConnectionRecord) {
                ...
                if (this.version == connectionRecord.version) {
                    if (Intrinsics.areEqual((Object) this.msg, (Object) connectionRecord.msg)) {
                        if (Intrinsics.areEqual((Object) this.f5org, (Object) connectionRecord.f5org)) {
                            if (Intrinsics.areEqual((Object) this.peripheral, (Object) connectionRecord.peripheral)) {
                                if (Intrinsics.areEqual((Object) this.central, (Object) connectionRecord.central)) {
                                    if (this.rssi == connectionRecord.rssi) {
                                    }
                                }
                            }
                        }
