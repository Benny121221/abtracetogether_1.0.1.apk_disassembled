...
import ca.albertahealthservices.contacttracing.streetpass.StreetPassWorker.CentralGattCallback;
...
public final class Work implements Comparable<Work> {
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0005\n\u0002\u0010\t\n\u0002\b\u0005\b\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002R\u001a\u0010\u0003\u001a\u00020\u0004X\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0005\u0010\u0006\"\u0004\b\u0007\u0010\bR\u001a\u0010\t\u001a\u00020\nX\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000b\u0010\f\"\u0004\b\r\u0010\u000e¨\u0006\u000f"}, d2 = {"Lca/albertahealthservices/contacttracing/streetpass/Work$Check;", "", "(Lca/albertahealthservices/contacttracing/streetpass/Work;)V", "status", "", "getStatus", "()Z", "setStatus", "(Z)V", "timePerformed", "", "getTimePerformed", "()J", "setTimePerformed", "(J)V", "app_release"}, k = 1, mv = {1, 1, 16})
    /* compiled from: Work.kt */
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0006"}, d2 = {"Lca/albertahealthservices/contacttracing/streetpass/Work$OnWorkTimeoutListener;", "", "onWorkTimeout", "", "work", "Lca/albertahealthservices/contacttracing/streetpass/Work;", "app_release"}, k = 1, mv = {1, 1, 16})
    /* compiled from: Work.kt */
    ...
    public final void startWork(Context context, CentralGattCallback centralGattCallback) {
        Intrinsics.checkParameterIsNotNull(context, "context");
        Intrinsics.checkParameterIsNotNull(centralGattCallback, "gattCallback");
        if (VERSION.SDK_INT >= 23) {
            this.gatt = this.device.connectGatt(context, false, centralGattCallback, 2);
        } else {
            this.gatt = this.device.connectGatt(context, false, centralGattCallback);
        }
        if (this.gatt == null) {
    ...
    public int compareTo(Work work) {
        ...
        return (getTimeStamp() > work.getTimeStamp() ? 1 : (getTimeStamp() == work.getTimeStamp() ? 0 : -1));
    }
}
