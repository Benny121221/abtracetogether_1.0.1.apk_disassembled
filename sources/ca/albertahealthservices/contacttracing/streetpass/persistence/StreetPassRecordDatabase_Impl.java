...
import ca.albertahealthservices.contacttracing.status.persistence.StatusRecordDao_Impl;
    ...
    public SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration databaseConfiguration) {
        return databaseConfiguration.sqliteOpenHelperFactory.create(Configuration.builder(databaseConfiguration.context).name(databaseConfiguration.name).callback(new RoomOpenHelper(databaseConfiguration, new Delegate(1) {
            ...
            public ValidationResult onValidateSchema(SupportSQLiteDatabase supportSQLiteDatabase) {
                ...
                Column column = new Column(WLConfig.APP_ID, "INTEGER", true, 1, null, 1);
                String str = WLConfig.APP_ID;
                ...
                Column column3 = new Column(SecurityUtils.VERSION_LABEL, "INTEGER", true, 0, null, 1);
                hashMap.put(SecurityUtils.VERSION_LABEL, column3);
                ...
                if (!tableInfo.equals(read)) {
                    ...
                    sb.append("record_table(ca.albertahealthservices.contacttracing.streetpass.persistence.StreetPassRecord).\n Expected:\n");
                    sb.append(tableInfo);
                    sb.append(str5);
                    sb.append(read);
                ...
                Column column10 = new Column(WLConfig.APP_ID, "INTEGER", true, 1, null, 1);
                ...
                sb2.append("status_table(ca.albertahealthservices.contacttracing.status.persistence.StatusRecord).\n Expected:\n");
