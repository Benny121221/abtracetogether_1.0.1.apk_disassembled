...
public final class BLEScanner {
    ...
    public final void startScan(ScanCallback scanCallback2) {
        ...
        ScanFilter build = new Builder().setServiceUuid(new ParcelUuid(UUID.fromString(getServiceUUID()))).build();
    ...
    public final void flush() {
        ...
        if (scanCallback2 != null) {
            BluetoothLeScanner bluetoothLeScanner = this.scanner;
            if (bluetoothLeScanner != null) {
                bluetoothLeScanner.flushPendingScanResults(scanCallback2);
            }
        }
    }
    ...
    public final void stopScan() {
        try {
            ...
            sb.append("unable to stop scanning - callback null or bluetooth off? : ");
