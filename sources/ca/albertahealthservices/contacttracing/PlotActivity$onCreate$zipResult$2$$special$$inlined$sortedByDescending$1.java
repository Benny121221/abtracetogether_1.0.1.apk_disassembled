...
public final class PlotActivity$onCreate$zipResult$2$$special$$inlined$sortedByDescending$1<T> implements Comparator<T> {
    public final int compare(T t, T t2) {
        return ComparisonsKt.compareValues(Long.valueOf(((StreetPassRecord) t2).getTimestamp()), Long.valueOf(((StreetPassRecord) t).getTimestamp()));
    }
}
