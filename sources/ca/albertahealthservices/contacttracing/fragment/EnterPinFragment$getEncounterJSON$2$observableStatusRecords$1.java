...
final class EnterPinFragment$getEncounterJSON$2$observableStatusRecords$1<T> implements ObservableOnSubscribe<T> {
    ...
    EnterPinFragment$getEncounterJSON$2$observableStatusRecords$1() {
    }
    ...
    public final void subscribe(ObservableEmitter<List<StatusRecord>> observableEmitter) {
        ...
        observableEmitter.onNext(new StatusRecordStorage(TracerApp.Companion.getAppContext()).getAllRecords());
    }
}
