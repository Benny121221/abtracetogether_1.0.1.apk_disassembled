...
final class VerifyCallerFragment$onViewCreated$2 implements OnClickListener {
    final /* synthetic */ VerifyCallerFragment this$0;

    VerifyCallerFragment$onViewCreated$2(VerifyCallerFragment verifyCallerFragment) {
    ...
    public final void onClick(View view) {
        ...
        if (parentFragment != null) {
            ((UploadPageFragment) parentFragment).navigateToOTCFragment();
            return;
        }
