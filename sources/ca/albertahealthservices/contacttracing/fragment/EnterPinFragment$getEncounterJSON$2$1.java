...
final class EnterPinFragment$getEncounterJSON$2$1<T1, T2, R> implements BiFunction<List<? extends StreetPassRecord>, List<? extends StatusRecord>, ExportData> {
    public static final EnterPinFragment$getEncounterJSON$2$1 INSTANCE = new EnterPinFragment$getEncounterJSON$2$1();

    EnterPinFragment$getEncounterJSON$2$1() {
    }
