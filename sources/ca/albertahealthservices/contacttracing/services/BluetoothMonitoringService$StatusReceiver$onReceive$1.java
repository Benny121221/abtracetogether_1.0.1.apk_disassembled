...
import ca.albertahealthservices.contacttracing.services.BluetoothMonitoringService.StatusReceiver;
...
@DebugMetadata(c = "ca.albertahealthservices.contacttracing.services.BluetoothMonitoringService$StatusReceiver$onReceive$1", f = "BluetoothMonitoringService.kt", i = {0}, l = {665}, m = "invokeSuspend", n = {"$this$launch"}, s = {"L$0"})
...
final class BluetoothMonitoringService$StatusReceiver$onReceive$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    final /* synthetic */ StatusReceiver this$0;

    BluetoothMonitoringService$StatusReceiver$onReceive$1(StatusReceiver statusReceiver, StatusRecord statusRecord, Continuation continuation) {
