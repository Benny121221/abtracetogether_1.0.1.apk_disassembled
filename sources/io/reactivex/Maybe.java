...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    public final Maybe<T> doOnSuccess(Consumer<? super T> consumer) {
        MaybePeek maybePeek = new MaybePeek(this, Functions.emptyConsumer(), (Consumer) ObjectHelper.requireNonNull(consumer, "onSuccess is null"), Functions.emptyConsumer(), Functions.EMPTY_ACTION, Functions.EMPTY_ACTION, Functions.EMPTY_ACTION);
        return RxJavaPlugins.onAssembly((Maybe<T>) maybePeek);
    }
