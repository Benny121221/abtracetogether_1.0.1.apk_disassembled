...
public class ContentFrameLayout extends FrameLayout {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (mode == Integer.MIN_VALUE) {
            ...
            if (!(typedValue2 == null || typedValue2.type == 0)) {
                if (typedValue2.type == 5) {
                    ...
                    i5 = 0;
                    if (i5 > 0) {
                        i = MeasureSpec.makeMeasureSpec(Math.min(i5 - (this.mDecorPadding.left + this.mDecorPadding.right), MeasureSpec.getSize(i)), Ints.MAX_POWER_OF_TWO);
                        z = true;
                        if (mode2 == Integer.MIN_VALUE) {
                            ...
                            if (!(typedValue3 == null || typedValue3.type == 0)) {
                                if (typedValue3.type == 5) {
                                    ...
                                    i4 = 0;
                                    if (i4 > 0) {
                                        i2 = MeasureSpec.makeMeasureSpec(Math.min(i4 - (this.mDecorPadding.top + this.mDecorPadding.bottom), MeasureSpec.getSize(i2)), Ints.MAX_POWER_OF_TWO);
                                    }
                                }
                                i4 = (int) fraction2;
                                if (i4 > 0) {
                        ...
                        if (!z && mode == Integer.MIN_VALUE) {
                            ...
                            if (!(typedValue == null || typedValue.type == 0)) {
                                if (typedValue.type != 5) {
                                    ...
                                    if (measuredWidth < i3) {
                                        makeMeasureSpec = MeasureSpec.makeMeasureSpec(i3, Ints.MAX_POWER_OF_TWO);
                                        if (z2) {
        ...
        super.onMeasure(i, i2);
        measuredWidth = getMeasuredWidth();
        int makeMeasureSpec2 = MeasureSpec.makeMeasureSpec(measuredWidth, Ints.MAX_POWER_OF_TWO);
        if (!z3) {
        }
        if (typedValue.type != 5) {
        }
