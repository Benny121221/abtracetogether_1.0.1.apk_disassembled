...
class TwilightManager {
    ...
    private void updateState(Location location) {
        ...
        twilightCalculator.calculateTwilight(currentTimeMillis - BuildConfig.PURGE_INTERVAL, location.getLatitude(), location.getLongitude());
        ...
        long j6 = j3;
        boolean z3 = z2;
        instance.calculateTwilight(BuildConfig.PURGE_INTERVAL + currentTimeMillis, location.getLatitude(), location.getLongitude());
        long j7 = instance.sunrise;
        if (j6 == -1 || j5 == -1) {
            j = 43200000 + currentTimeMillis;
        } else {
            long j8 = currentTimeMillis > j5 ? 0 + j7 : currentTimeMillis > j6 ? 0 + j5 : 0 + j6;
            j = j8 + BuildConfig.MAX_SCAN_INTERVAL;
        }
