                    ...
                    for (int i7 = this.mCurItem - 1; i7 >= 0; i7--) {
                        if (f3 < f || i7 >= max) {
                            if (itemInfo4 == null || i7 != itemInfo4.position) {
                                ...
                                i5++;
                                if (i6 >= 0) {
                                    itemInfo3 = (ItemInfo) this.mItems.get(i6);
                                    itemInfo4 = itemInfo3;
                                }
                            } else {
                            ...
                            if (f4 < f2 || i9 <= min) {
                                if (itemInfo5 == null || i9 != itemInfo5.position) {
                                    ...
                                    if (i8 < this.mItems.size()) {
                                        itemInfo5 = (ItemInfo) this.mItems.get(i8);
                                    }
                                } else {
                                ...
                                break;
                            } else if (i9 == itemInfo5.position && !itemInfo5.scrolling) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams != null && layoutParams.isDecor) {
                    ...
                    if (layoutParams.height != -2) {
                        i6 = layoutParams.height != -1 ? layoutParams.height : measuredHeight;
                    } else {
                        i6 = measuredHeight;
                        i8 = i3;
                    }
                    childAt.measure(MeasureSpec.makeMeasureSpec(i5, i4), MeasureSpec.makeMeasureSpec(i6, i8));
                    if (z3) {
        ...
        for (int i12 = 0; i12 < childCount2; i12++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (layoutParams2 == null || !layoutParams2.isDecor) {
                    childAt2.measure(MeasureSpec.makeMeasureSpec((int) (((float) paddingLeft) * layoutParams2.widthFactor), Ints.MAX_POWER_OF_TWO), this.mChildHeightMeasureSpec);
                }
            }
        }
    }
        ...
        for (int i19 = 0; i19 < childCount; i19++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isDecor) {
                    ...
                    if (infoForChild != null) {
                        float f = (float) i18;
                        int i20 = ((int) (infoForChild.offset * f)) + paddingLeft;
                        if (layoutParams2.needsMeasure) {
                            layoutParams2.needsMeasure = false;
                            childAt2.measure(MeasureSpec.makeMeasureSpec((int) (f * layoutParams2.widthFactor), Ints.MAX_POWER_OF_TWO), MeasureSpec.makeMeasureSpec((i10 - paddingTop) - paddingBottom, Ints.MAX_POWER_OF_TWO));
                        }
