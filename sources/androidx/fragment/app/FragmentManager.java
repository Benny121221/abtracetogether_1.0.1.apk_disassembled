...
public abstract class FragmentManager {
    ...
    public void addRetainedFragment(Fragment fragment) {
        ...
        if (this.mNonConfig.addRetainedFragment(fragment) && isLoggingEnabled(2)) {
            StringBuilder sb = new StringBuilder();
    ...
    public void removeRetainedFragment(Fragment fragment) {
        ...
        if (this.mNonConfig.removeRetainedFragment(fragment) && isLoggingEnabled(2)) {
            StringBuilder sb = new StringBuilder();
    ...
    public void moveToState(Fragment fragment, int i) {
        ...
        if (i3 <= min) {
            ...
            if (i4 != -1) {
                ...
                String str2 = " that does not belong to this FragmentManager!";
                ...
                if (fragment.mTargetWho != null) {
                    Fragment findActiveFragment = findActiveFragment(fragment.mTargetWho);
                    if (findActiveFragment == null) {
                        StringBuilder sb3 = new StringBuilder();
                        sb3.append(str4);
                        sb3.append(fragment);
                        sb3.append(str3);
                        sb3.append(fragment.mTargetWho);
                        sb3.append(str2);
                        throw new IllegalStateException(sb3.toString());
                    } else if (findActiveFragment.mState < 1) {
                        moveToState(findActiveFragment, 1);
                    }
                }
            ...
            if (i5 != 0) {
                ...
                if (min < 1) {
                    ...
                    } else if (fragment.mTargetWho != null) {
                        Fragment findActiveFragment2 = findActiveFragment(fragment.mTargetWho);
                        if (findActiveFragment2 != null && findActiveFragment2.getRetainInstance()) {
                            fragment.mTarget = findActiveFragment2;
                        }
                    }
                    if (this.mExitAnimationCancellationSignals.get(fragment) != null) {
                        fragment.setStateAfterAnimating(min);
        ...
        if (fragment.mState != min) {
            if (isLoggingEnabled(3)) {
                ...
                sb5.append(fragment);
                sb5.append(" not updated inline; expected state ");
                sb5.append(min);
                sb5.append(" found ");
                sb5.append(fragment.mState);
    ...
    private void completeShowHideFragment(final Fragment fragment) {
        if (fragment.mView != null) {
            AnimationOrAnimator loadAnimation = FragmentAnim.loadAnimation(this.mHost.getContext(), this.mContainer, fragment, !fragment.mHidden);
    ...
    public void moveFragmentToExpectedState(Fragment fragment) {
        ...
        if (fragment.mView != null) {
            ...
            if (fragment.mIsNewlyAdded && fragment.mContainer != null) {
                ...
                AnimationOrAnimator loadAnimation = FragmentAnim.loadAnimation(this.mHost.getContext(), this.mContainer, fragment, true);
                if (loadAnimation != null) {
                ...
                while (true) {
                    ...
                    if (fragmentState != null) {
                        ...
                        if (findRetainedFragmentByWho != null) {
                            ...
                            fragmentStateManager = new FragmentStateManager(this.mLifecycleCallbacksDispatcher, findRetainedFragmentByWho, fragmentState);
                        } else {
