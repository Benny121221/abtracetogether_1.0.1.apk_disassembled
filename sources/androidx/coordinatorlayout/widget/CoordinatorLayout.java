            ...
            if (view.getVisibility() == 8) {
                ...
                if (layoutParams2.keyline < 0 || mode == 0) {
                    ...
                    if ((absoluteGravity == 3 && !z) || (absoluteGravity == 5 && z)) {
                        ...
                        int max2 = Math.max(i10, i14 + view.getMeasuredHeight() + layoutParams3.topMargin + layoutParams3.bottomMargin);
                        ...
                        if (z2 || ViewCompat.getFitsSystemWindows(view)) {
                            ...
                            i8 = MeasureSpec.makeMeasureSpec(size2 - systemWindowInsetTop, mode2);
                        }
                        behavior = layoutParams2.getBehavior();
                        if (behavior != null) {
                        ...
                        int max22 = Math.max(i10, i14 + view.getMeasuredHeight() + layoutParams32.topMargin + layoutParams32.bottomMargin);
                        i17 = View.combineMeasuredStates(i11, view.getMeasuredState());
                        i15 = max3;
                        i16 = max22;
                    }
                ...
                int max32 = Math.max(i12, i13 + view.getMeasuredWidth() + layoutParams322.leftMargin + layoutParams322.rightMargin);
                int max222 = Math.max(i10, i14 + view.getMeasuredHeight() + layoutParams322.topMargin + layoutParams322.bottomMargin);
                i17 = View.combineMeasuredStates(i11, view.getMeasuredState());
                i15 = max32;
                i16 = max222;
            }
