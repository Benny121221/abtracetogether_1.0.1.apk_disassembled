        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    i11 = MeasureSpec.makeMeasureSpec(paddingLeft - i15, Integer.MIN_VALUE);
                } else if (layoutParams.width == -1) {
                    i11 = MeasureSpec.makeMeasureSpec(paddingLeft - i15, Ints.MAX_POWER_OF_TWO);
                } else {
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                ...
                                if (z2) {
                                    ...
                                    i6 = i16;
                                    int makeMeasureSpec = MeasureSpec.makeMeasureSpec(i18, Ints.MAX_POWER_OF_TWO);
                                    if (i7 != i18) {
                            ...
                            childAt2.measure(MeasureSpec.makeMeasureSpec(i16, i9), i10);
                        }
                    }
                }
                i6 = i16;
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.slideable) {
                    ...
                    int min = (Math.min(paddingRight, i11 - this.mOverhangSize) - i9) - (layoutParams.leftMargin + layoutParams.rightMargin);
                    this.mSlideRange = min;
                    int i12 = isLayoutRtlSupport ? layoutParams.rightMargin : layoutParams.leftMargin;
                    layoutParams.dimWhenOffset = ((i9 + i12) + min) + (measuredWidth / 2) > i11;
                    ...
                    if (this.mCanSlide) {
                        int i14 = this.mParallaxBy;
                        if (i14 != 0) {
                            i5 = (int) ((1.0f - this.mSlideOffset) * ((float) i14));
                            i9 = paddingRight;
                        }
                    }
                    i9 = paddingRight;
