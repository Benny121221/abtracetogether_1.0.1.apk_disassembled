...
public class NotificationCompat {
    ...
    public static final class CarExtender implements Extender {
        ...
        /* JADX WARNING: type inference failed for: r9v0, types: [androidx.core.app.RemoteInput] */
        /* JADX WARNING: type inference failed for: r7v0, types: [androidx.core.app.NotificationCompat$CarExtender$UnreadConversation] */
        /* JADX WARNING: type inference failed for: r13v1, types: [androidx.core.app.RemoteInput] */
        /* JADX WARNING: type inference failed for: r7v4, types: [androidx.core.app.NotificationCompat$CarExtender$UnreadConversation] */
        /* JADX WARNING: type inference failed for: r13v2, types: [androidx.core.app.RemoteInput] */
        /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r1v0
  assigns: [?[int, float, boolean, short, byte, char, OBJECT, ARRAY], androidx.core.app.NotificationCompat$CarExtender$UnreadConversation, androidx.core.app.RemoteInput]
  ...
  mth insns count: 58
        ...
        private static UnreadConversation getUnreadConversationFromBundle(Bundle bundle) {
            ...
            if (stringArray != null && stringArray.length == 1) {
                ...
                ? unreadConversation = new UnreadConversation(strArr, r1, pendingIntent2, pendingIntent, stringArray, bundle2.getLong(KEY_TIMESTAMP));
        ...
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (VERSION.SDK_INT >= 16 && VERSION.SDK_INT < 21) {
                ...
                if (z6) {
                    ...
                    remoteViews.setInt(R.id.icon, str, R.drawable.notification_template_icon_low_bg);
                } else {
                    remoteViews.setInt(R.id.notification_background, str, R.drawable.notification_bg);
                    remoteViews.setInt(R.id.icon, str, R.drawable.notification_template_icon_bg);
                }
            }
            ...
            boolean z7 = VERSION.SDK_INT < 21 && this.mBuilder.mLargeIcon != null;
                ...
                if (this.mBuilder.mSubText != null && VERSION.SDK_INT >= 16) {
                    ...
                    if (this.mBuilder.mContentText == null) {
                        ...
                        if (this.mBuilder.getWhenIfShowing() != 0) {
                            z5 = z7;
                        } else if (!this.mBuilder.mUseChronometer || VERSION.SDK_INT < 16) {
