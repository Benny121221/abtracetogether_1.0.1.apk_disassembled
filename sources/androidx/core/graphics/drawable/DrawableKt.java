...
public final class DrawableKt {
     ...
     */
    public static final Bitmap toBitmap(Drawable drawable, int i, int i2, Config config) {
        Intrinsics.checkParameterIsNotNull(drawable, "$this$toBitmap");
        String str = "bitmap";
        if (drawable instanceof BitmapDrawable) {
            if (config != null) {
                Bitmap bitmap = ((BitmapDrawable) drawable).getBitmap();
                Intrinsics.checkExpressionValueIsNotNull(bitmap, str);
            }
            BitmapDrawable bitmapDrawable = (BitmapDrawable) drawable;
            if (i == bitmapDrawable.getIntrinsicWidth() && i2 == bitmapDrawable.getIntrinsicHeight()) {
                Bitmap bitmap2 = bitmapDrawable.getBitmap();
                Intrinsics.checkExpressionValueIsNotNull(bitmap2, str);
                return bitmap2;
            }
