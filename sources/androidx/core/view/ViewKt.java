...
public final class ViewKt {
    ...
    public static final Bitmap drawToBitmap(View view, Config config) {
    ...
    private static final <T extends LayoutParams> void updateLayoutParamsTyped(View view, Function1<? super T, Unit> function1) {
    ...
    public static final void updateLayoutParams(View view, Function1<? super LayoutParams, Unit> function1) {
