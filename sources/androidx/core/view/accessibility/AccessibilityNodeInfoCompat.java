...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        public boolean perform(View view, Bundle bundle) {
            Class<? extends CommandArguments> cls;
            String str;
            ...
            if (cls2 != null) {
                try {
                    CommandArguments commandArguments2 = (CommandArguments) cls2.getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
                    try {
