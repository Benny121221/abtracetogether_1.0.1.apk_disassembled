...
public class AppSettingsDialog implements Parcelable {
    ...
    public static class Builder {
        ...
        public AppSettingsDialog build() {
            ...
            AppSettingsDialog appSettingsDialog = new AppSettingsDialog(this.mActivityOrFragment, this.mThemeResId, this.mRationale, this.mTitle, this.mPositiveButtonText, this.mNegativeButtonText, this.mRequestCode, i2);
    ...
    public AlertDialog showDialog(OnClickListener onClickListener, OnClickListener onClickListener2) {
        androidx.appcompat.app.AlertDialog.Builder builder;
        if (this.mThemeResId != -1) {
            builder = new androidx.appcompat.app.AlertDialog.Builder(this.mContext, this.mThemeResId);
        } else {
            builder = new androidx.appcompat.app.AlertDialog.Builder(this.mContext);
        }
