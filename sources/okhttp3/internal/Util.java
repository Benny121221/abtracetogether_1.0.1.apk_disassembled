...
public final class Util {
    ...
    public static String md5Hex(String str) {
        try {
            return ByteString.of(MessageDigest.getInstance(SecurityUtils.HASH_ALGORITH_MD5).digest(str.getBytes("UTF-8"))).hex();
    ...
    public static String shaBase64(String str) {
        try {
            return ByteString.of(MessageDigest.getInstance(SecurityUtils.HASH_ALGORITH_SHA1).digest(str.getBytes("UTF-8"))).base64();
        } catch (UnsupportedEncodingException | NoSuchAlgorithmException e) {
            throw new AssertionError(e);
        }
    }
    ...
    public static ByteString sha1(ByteString byteString) {
        try {
            return ByteString.of(MessageDigest.getInstance(SecurityUtils.HASH_ALGORITH_SHA1).digest(byteString.toByteArray()));
