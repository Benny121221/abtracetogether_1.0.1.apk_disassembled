        ...
        for (int i = 0; i < size; i++) {
            ...
            if ("Basic".equalsIgnoreCase(challenge.scheme())) {
                ...
                if (passwordAuthentication != null) {
                    return request.newBuilder().header(z ? HttpHeaders.PROXY_AUTHORIZATION : HttpHeaders.AUTHORIZATION, Credentials.basic(passwordAuthentication.getUserName(), new String(passwordAuthentication.getPassword()))).build();
                }
            }
        }
        return null;
