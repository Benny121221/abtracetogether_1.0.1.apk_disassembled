...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    private boolean requiresCompatShadow() {
        return VERSION.SDK_INT < 21 || (!isRoundRect() && !this.path.isConvex() && VERSION.SDK_INT < 29);
    }
        ...
        if (this.drawableState.fillColor != null) {
            ...
            if (color != colorForState) {
                ...
                if (this.drawableState.strokeColor != null) {
                    ...
                    int colorForState2 = this.drawableState.strokeColor.getColorForState(iArr, color2);
