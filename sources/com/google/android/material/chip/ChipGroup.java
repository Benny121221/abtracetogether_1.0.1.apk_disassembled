...
public class ChipGroup extends FlowLayout {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        AccessibilityNodeInfoCompat.wrap(accessibilityNodeInfo).setCollectionInfo(CollectionInfoCompat.obtain(getRowCount(), isSingleLine() ? getChipCount() : -1, false, isSingleSelection() ? 1 : 2));
    }
