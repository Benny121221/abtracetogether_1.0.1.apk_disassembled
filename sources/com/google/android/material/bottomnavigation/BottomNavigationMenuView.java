...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        AccessibilityNodeInfoCompat.wrap(accessibilityNodeInfo).setCollectionInfo(CollectionInfoCompat.obtain(1, this.menu.getVisibleItems().size(), false, 1));
    }
    ...
    private void setBadgeIfNeeded(BottomNavigationItemView bottomNavigationItemView) {
        ...
        if (isValidId(id)) {
            BadgeDrawable badgeDrawable = (BadgeDrawable) this.badgeDrawables.get(id);
            if (badgeDrawable != null) {
