...
public class AppBarLayout extends LinearLayout implements AttachedBehavior {
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private void updateAccessibilityActions(CoordinatorLayout coordinatorLayout, T t) {
            ...
            if (findFirstScrollingChild != null && t.getTotalScrollRange() != 0 && (((androidx.coordinatorlayout.widget.CoordinatorLayout.LayoutParams) findFirstScrollingChild.getLayoutParams()).getBehavior() instanceof ScrollingViewBehavior)) {
        ...
        private void addAccessibilityScrollActions(CoordinatorLayout coordinatorLayout, T t, View view) {
            if (getTopBottomOffsetForScrollingSibling() != (-t.getTotalScrollRange()) && view.canScrollVertically(1)) {
                addActionToExpand(coordinatorLayout, t, AccessibilityActionCompat.ACTION_SCROLL_FORWARD, false);
            }
            ...
            addActionToExpand(coordinatorLayout, t, AccessibilityActionCompat.ACTION_SCROLL_BACKWARD, true);
        }

        private void addActionToExpand(CoordinatorLayout coordinatorLayout, final T t, AccessibilityActionCompat accessibilityActionCompat, final boolean z) {
            ViewCompat.replaceAccessibilityAction(coordinatorLayout, accessibilityActionCompat, null, new AccessibilityViewCommand() {
                public boolean perform(View view, CommandArguments commandArguments) {
                    t.setExpanded(z);
                    return true;
                }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (mode != 1073741824 && ViewCompat.getFitsSystemWindows(this) && shouldOffsetFirstChild()) {
            ...
            if (mode == Integer.MIN_VALUE) {
                measuredHeight = MathUtils.clamp(getMeasuredHeight() + getTopInset(), 0, MeasureSpec.getSize(i2));
            } else if (mode == 0) {
