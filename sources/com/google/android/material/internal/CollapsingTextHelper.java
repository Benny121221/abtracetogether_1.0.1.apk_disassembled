...
public final class CollapsingTextHelper {
    ...
    private float getCollapsedTextLeftBound(int i, int i2) {
        ...
        if ((i2 & GravityCompat.END) == 8388613 || (i2 & 5) == 5) {
            return this.isRtl ? (float) this.collapsedBounds.left : ((float) this.collapsedBounds.right) - calculateCollapsedTextWidth();
        }
        return this.isRtl ? ((float) this.collapsedBounds.right) - calculateCollapsedTextWidth() : (float) this.collapsedBounds.left;
    }
    ...
    private float getCollapsedTextRightBound(RectF rectF, int i, int i2) {
        ...
        if ((i2 & GravityCompat.END) == 8388613 || (i2 & 5) == 5) {
            return this.isRtl ? rectF.left + calculateCollapsedTextWidth() : (float) this.collapsedBounds.right;
        }
