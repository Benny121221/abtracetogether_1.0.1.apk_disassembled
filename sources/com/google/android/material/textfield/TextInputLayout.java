...
public class TextInputLayout extends LinearLayout {
    ...
    public TextInputLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        int i2 = i;
        super(MaterialThemeOverlay.wrap(context, attributeSet2, i2, DEF_STYLE_RES), attributeSet2, i2);
        ...
        this.startLayout.setLayoutParams(new LayoutParams(-2, -1, GravityCompat.START));
        this.inputFrame.addView(this.startLayout);
        LinearLayout linearLayout2 = new LinearLayout(context2);
        this.endLayout = linearLayout2;
        linearLayout2.setOrientation(0);
        this.endLayout.setLayoutParams(new LayoutParams(-2, -1, GravityCompat.END));
        ...
        Builder builder = this.shapeAppearanceModel.toBuilder();
        if (dimension >= 0.0f) {
        ...
        CheckableImageButton checkableImageButton = (CheckableImageButton) LayoutInflater.from(getContext()).inflate(R.layout.design_text_input_end_icon, this.endLayout, false);
        ...
        int i4 = resourceId4;
        CheckableImageButton checkableImageButton2 = (CheckableImageButton) LayoutInflater.from(getContext()).inflate(R.layout.design_text_input_start_icon, this.startLayout, false);
        ...
        CheckableImageButton checkableImageButton3 = (CheckableImageButton) LayoutInflater.from(getContext()).inflate(R.layout.design_text_input_end_icon, this.endIconFrame, false);
    ...
    public void setCounterEnabled(boolean z) {
        if (this.counterEnabled != z) {
            if (z) {
                ...
                MarginLayoutParamsCompat.setMarginStart((MarginLayoutParams) this.counterView.getLayoutParams(), getResources().getDimensionPixelOffset(R.dimen.mtrl_textinput_counter_margin_start));
    ...
    private void updatePlaceholderMeasurementsBasedOnEditText() {
        if (this.placeholderTextView != null) {
            EditText editText2 = this.editText;
            if (editText2 != null) {
                this.placeholderTextView.setGravity((editText2.getGravity() & -113) | 48);
        ...
        if (shouldUpdateStartDummyDrawable()) {
            ...
            if (shouldUpdateEndDummyDrawable()) {
                ...
                if (endIconToUpdateDummyDrawable != null) {
                    measuredWidth2 = measuredWidth2 + endIconToUpdateDummyDrawable.getMeasuredWidth() + MarginLayoutParamsCompat.getMarginStart((MarginLayoutParams) endIconToUpdateDummyDrawable.getLayoutParams());
                }
    ...
    private static void setIconOnClickListener(CheckableImageButton checkableImageButton, OnClickListener onClickListener, OnLongClickListener onLongClickListener) {
        checkableImageButton.setOnClickListener(onClickListener);
        setIconClickable(checkableImageButton, onLongClickListener);
    }

    private static void setIconOnLongClickListener(CheckableImageButton checkableImageButton, OnLongClickListener onLongClickListener) {
        checkableImageButton.setOnLongClickListener(onLongClickListener);
        setIconClickable(checkableImageButton, onLongClickListener);
    }

    private static void setIconClickable(CheckableImageButton checkableImageButton, OnLongClickListener onLongClickListener) {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (editText2 != null) {
            ...
            if (this.hintEnabled) {
                this.collapsingTextHelper.setExpandedTextSize(this.editText.getTextSize());
                int gravity = this.editText.getGravity() & -113;
                this.collapsingTextHelper.setCollapsedTextGravity(gravity | 48);
                this.collapsingTextHelper.setExpandedTextGravity(gravity);
