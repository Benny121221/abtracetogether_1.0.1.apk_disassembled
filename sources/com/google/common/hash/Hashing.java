...
public final class Hashing {
    ...
    private static class Md5Holder {
        static final HashFunction MD5 = new MessageDigestHashFunction(SecurityUtils.HASH_ALGORITH_MD5, "Hashing.md5()");
    ...
    private static class Sha1Holder {
        static final HashFunction SHA_1 = new MessageDigestHashFunction(SecurityUtils.HASH_ALGORITH_SHA1, "Hashing.sha1()");
