...
public final class MediaType {
    ...
    static {
        ...
        HEIF = createConstant(str3, "heif");
        JP2K = createConstant(str3, "jp2");
        String str9 = "mp4";
        ...
        MICROSOFT_OUTLOOK = createConstant(str6, "vnd.ms-outlook");
        MICROSOFT_POWERPOINT = createConstant(str6, "vnd.ms-powerpoint");
        MICROSOFT_WORD = createConstant(str6, "msword");
        MEDIA_PRESENTATION_DESCRIPTION = createConstant(str6, "dash+xml");
        WASM_APPLICATION = createConstant(str6, "wasm");
        ...
        OPENSEARCH_DESCRIPTION_UTF_8 = createConstantUtf8(str6, "opensearchdescription+xml");
