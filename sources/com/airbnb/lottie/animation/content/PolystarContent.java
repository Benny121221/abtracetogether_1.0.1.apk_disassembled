...
public class PolystarContent implements PathContent, AnimationListener, KeyPathElementContent {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            iArr[Type.STAR.ordinal()] = 1;
            $SwitchMap$com$airbnb$lottie$model$content$PolystarShape$Type[Type.POLYGON.ordinal()] = 2;
        }
    }
        ...
        while (true) {
            ...
            if (d7 < ceil) {
                ...
                if (floatValue4 == 0.0f && floatValue5 == 0.0f) {
                    ...
                    float f17 = (z ? f14 : f13) * f16 * POLYSTAR_MAGIC_NUMBER;
                    float f18 = cos3 * f17;
                    float f19 = f17 * sin3;
                    float f20 = (z ? f13 : f14) * (z ? floatValue5 : f9) * POLYSTAR_MAGIC_NUMBER;
                    float f21 = cos4 * f20;
                    float f22 = f20 * sin4;
                    if (i != 0) {
                        if (i3 == 0) {
                    ...
                    this.path.cubicTo(f3 - f18, f2 - f19, cos2 + f21, sin2 + f22, cos2, sin2);
                }
                d2 += (double) f5;
                z = !z;
                i3++;
