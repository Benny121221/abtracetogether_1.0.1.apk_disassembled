...
public abstract class BaseLayer implements DrawingContent, AnimationListener, KeyPathElement {
    ...
    static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            try {
                iArr[MaskMode.MASK_MODE_NONE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$airbnb$lottie$model$content$Mask$MaskMode[MaskMode.MASK_MODE_SUBTRACT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$airbnb$lottie$model$content$Mask$MaskMode[MaskMode.MASK_MODE_INTERSECT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$airbnb$lottie$model$content$Mask$MaskMode[MaskMode.MASK_MODE_ADD.ordinal()] = 4;
            ...
            $SwitchMap$com$airbnb$lottie$model$layer$Layer$LayerType[LayerType.PRE_COMP.ordinal()] = 2;
            $SwitchMap$com$airbnb$lottie$model$layer$Layer$LayerType[LayerType.SOLID.ordinal()] = 3;
            $SwitchMap$com$airbnb$lottie$model$layer$Layer$LayerType[LayerType.IMAGE.ordinal()] = 4;
            $SwitchMap$com$airbnb$lottie$model$layer$Layer$LayerType[LayerType.NULL.ordinal()] = 5;
            $SwitchMap$com$airbnb$lottie$model$layer$Layer$LayerType[LayerType.TEXT.ordinal()] = 6;
            try {
                $SwitchMap$com$airbnb$lottie$model$layer$Layer$LayerType[LayerType.UNKNOWN.ordinal()] = 7;
