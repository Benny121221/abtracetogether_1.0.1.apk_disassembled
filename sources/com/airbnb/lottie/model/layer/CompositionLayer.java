...
public class CompositionLayer extends BaseLayer {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            int[] iArr = new int[MatteType.values().length];
            $SwitchMap$com$airbnb$lottie$model$layer$Layer$MatteType = iArr;
            iArr[MatteType.ADD.ordinal()] = 1;
            $SwitchMap$com$airbnb$lottie$model$layer$Layer$MatteType[MatteType.INVERT.ordinal()] = 2;
        }
    }
