...
public final class UInt implements Comparable<UInt> {
    ...
    private static final int m83compareTo7apg3OU(int i, byte b) {
        return UnsignedKt.uintCompare(i, m88constructorimpl(b & 255));
    }
    ...
    private static final int m104plus7apg3OU(int i, byte b) {
        return m88constructorimpl(i + m88constructorimpl(b & 255));
    }
    ...
    private static final int m90div7apg3OU(int i, byte b) {
        return UnsignedKt.m314uintDivideJ1ME1BU(i, m88constructorimpl(b & 255));
    }
    ...
    private static final int m109rem7apg3OU(int i, byte b) {
        return UnsignedKt.m315uintRemainderJ1ME1BU(i, m88constructorimpl(b & 255));
    }
