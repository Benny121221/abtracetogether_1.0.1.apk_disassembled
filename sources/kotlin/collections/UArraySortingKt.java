...
public final class UArraySortingKt {
    ...
    private static final int m323partition4UcCI2c(byte[] bArr, int i, int i2) {
        ...
        while (i <= i2) {
            while (true) {
                b = b2 & 255;
                if (Intrinsics.compare((int) UByteArray.m70getimpl(bArr, i) & 255, (int) b) >= 0) {
                    break;
                }
                i++;
            }
            while (Intrinsics.compare((int) UByteArray.m70getimpl(bArr, i2) & 255, (int) b) > 0) {
                i2--;
            }
            if (i <= i2) {
                byte b3 = UByteArray.m70getimpl(bArr, i);
                UByteArray.m75setVurrAj0(bArr, i, UByteArray.m70getimpl(bArr, i2));
                UByteArray.m75setVurrAj0(bArr, i2, b3);
                i++;
                i2--;
            }
        }
    ...
    private static final int m324partitionAa5vz7o(short[] sArr, int i, int i2) {
        short s;
        short s2 = UShortArray.m303getimpl(sArr, (i + i2) / 2);
        while (i <= i2) {
            while (true) {
                s = s2 & UShort.MAX_VALUE;
                if (Intrinsics.compare((int) UShortArray.m303getimpl(sArr, i) & UShort.MAX_VALUE, (int) s) >= 0) {
                    break;
                }
                i++;
            }
            while (Intrinsics.compare((int) UShortArray.m303getimpl(sArr, i2) & UShort.MAX_VALUE, (int) s) > 0) {
                i2--;
            }
            if (i <= i2) {
                short s3 = UShortArray.m303getimpl(sArr, i);
                UShortArray.m308set01HTLdE(sArr, i, UShortArray.m303getimpl(sArr, i2));
                UShortArray.m308set01HTLdE(sArr, i2, s3);
                i++;
                i2--;
            }
        }
