...
public final class UStringsKt {
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r5 = UInt.m88constructorimpl(i);
        int i4 = 119304647;
        while (i3 < length) {
            ...
            if (UnsignedKt.uintCompare(i2, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m314uintDivideJ1ME1BU(-1, r5);
                    if (UnsignedKt.uintCompare(i2, i4) > 0) {
                    }
                }
                return null;
            }
            int r3 = UInt.m88constructorimpl(i2 * r5);
            int r8 = UInt.m88constructorimpl(UInt.m88constructorimpl(digitOf) + r3);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r9 = ULong.m157constructorimpl((long) i2);
        long j2 = 0;
        ...
        while (i3 < length) {
            ...
            if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                if (j3 == 512409557603043100L) {
                    j3 = UnsignedKt.m316ulongDivideeb3DHEI(j, r9);
                    if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                    }
                }
                return null;
            }
            long r11 = ULong.m157constructorimpl(j2 * r9);
            long r4 = ULong.m157constructorimpl(ULong.m157constructorimpl(((long) UInt.m88constructorimpl(digitOf)) & 4294967295L) + r11);
