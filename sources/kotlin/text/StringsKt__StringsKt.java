...
class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    private static final <C extends CharSequence & R, R> R ifEmpty(C r1, Function0<? extends R> function0) {
        return r1.length() == 0 ? function0.invoke() : r1;
    }

    /* JADX WARNING: type inference failed for: r1v0, types: [R, C, java.lang.CharSequence] */
    /* JADX WARNING: Incorrect type for immutable var: ssa=C, code=null, for r1v0, types: [R, C, java.lang.CharSequence] */
    /* JADX WARNING: Unknown variable types count: 1 */
    private static final <C extends CharSequence & R, R> R ifBlank(C r1, Function0<? extends R> function0) {
        return StringsKt.isBlank(r1) ? function0.invoke() : r1;
    }
