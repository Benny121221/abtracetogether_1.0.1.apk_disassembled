...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
        ...
        if (obj instanceof ULongProgression) {
            if (!isEmpty() || !((ULongProgression) obj).isEmpty()) {
                ...
                if (this.first == uLongProgression.first) {
                    if (this.last == uLongProgression.last) {
                    }
                }
            }
            return true;
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int r0 = ((int) ULong.m157constructorimpl(j ^ ULong.m157constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int r02 = (r0 + ((int) ULong.m157constructorimpl(j2 ^ ULong.m157constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
