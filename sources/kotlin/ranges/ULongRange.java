...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ULongRange) {
            if (!isEmpty() || !((ULongRange) obj).isEmpty()) {
                ...
                if (getFirst() == uLongRange.getFirst()) {
                }
            }
            return true;
        }
    ...
    public int hashCode() {
        ...
        return (((int) ULong.m157constructorimpl(getFirst() ^ ULong.m157constructorimpl(getFirst() >>> 32))) * 31) + ((int) ULong.m157constructorimpl(getLast() ^ ULong.m157constructorimpl(getLast() >>> 32)));
    }

    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append(ULong.m194toStringimpl(getFirst()));
        sb.append("..");
        sb.append(ULong.m194toStringimpl(getLast()));
        return sb.toString();
    }
