...
public interface Deferred<T> extends Job {
    ...
    public static final class DefaultImpls {
        public static <T, R> R fold(Deferred<? extends T> deferred, R r, Function2<? super R, ? super Element, ? extends R> function2) {
            Intrinsics.checkParameterIsNotNull(function2, "operation");
            return kotlinx.coroutines.Job.DefaultImpls.fold(deferred, r, function2);
        }

        public static <T, E extends Element> E get(Deferred<? extends T> deferred, Key<E> key) {
            Intrinsics.checkParameterIsNotNull(key, "key");
            return kotlinx.coroutines.Job.DefaultImpls.get(deferred, key);
        }

        public static <T> CoroutineContext minusKey(Deferred<? extends T> deferred, Key<?> key) {
            Intrinsics.checkParameterIsNotNull(key, "key");
