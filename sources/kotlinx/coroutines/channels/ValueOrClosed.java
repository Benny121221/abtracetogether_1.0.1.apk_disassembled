...
public final class ValueOrClosed<T> {
    ...
    public static final class Companion {
        ...
        public final <E> Object value$kotlinx_coroutines_core(E e) {
            return ValueOrClosed.m980constructorimpl(e);
        }

        public final <E> Object closed$kotlinx_coroutines_core(Throwable th) {
            return ValueOrClosed.m980constructorimpl(new Closed(th));
        }
    }

    /* renamed from: box-impl reason: not valid java name */
    public static final /* synthetic */ ValueOrClosed m979boximpl(Object obj) {
    ...
    public static Object m980constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl reason: not valid java name */
    public static boolean m981equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof ValueOrClosed) && Intrinsics.areEqual(obj, ((ValueOrClosed) obj2).m989unboximpl());
    }

    /* renamed from: equals-impl0 reason: not valid java name */
    public static final boolean m982equalsimpl0(Object obj, Object obj2) {
        throw null;
    }

    /* renamed from: hashCode-impl reason: not valid java name */
    public static int m986hashCodeimpl(Object obj) {
        if (obj != null) {
            return obj.hashCode();
        }
        return 0;
    ...
    public boolean equals(Object obj) {
        return m981equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m986hashCodeimpl(this.holder);
    }

    public String toString() {
        return m988toStringimpl(this.holder);
    }

    /* renamed from: unbox-impl reason: not valid java name */
    public final /* synthetic */ Object m989unboximpl() {
        return this.holder;
    }
    ...
    public static final boolean m987isClosedimpl(Object obj) {
        return obj instanceof Closed;
    }

    /* renamed from: getValue-impl reason: not valid java name */
    public static final T m984getValueimpl(Object obj) {
    ...
    public static final T m985getValueOrNullimpl(Object obj) {
        if (obj instanceof Closed) {
            return null;
        }
        return obj;
    ...
    public static final Throwable m983getCloseCauseimpl(Object obj) {
        if (obj instanceof Closed) {
    ...
    public static String m988toStringimpl(Object obj) {
        if (obj instanceof Closed) {
            return obj.toString();
        }
        StringBuilder sb = new StringBuilder();
