...
public final class ExceptionsConstuctorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                e2 = Result.m3constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Companion companion2 = Result.Companion;
                e2 = Result.m3constructorimpl(ResultKt.createFailure(th));
            }
            if (!Result.m9isFailureimpl(e2)) {
                e3 = e2;
            }
            return (Throwable) e3;
        }
        ...
        try {
            ...
            if (throwableFields != fieldsCountOrDefault(e.getClass(), i)) {
                ...
                for (Constructor constructor : ArraysKt.sortedWith((T[]) constructors, (Comparator<? super T>) new ExceptionsConstuctorKt$tryCopyException$$inlined$sortedByDescending$1<Object>())) {
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Companion companion = Result.Companion;
            obj = Result.m3constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Companion companion2 = Result.Companion;
