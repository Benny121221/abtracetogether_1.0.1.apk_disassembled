...
final /* synthetic */ class FlowKt__EmittersKt {
    ...
    public static final /* synthetic */ <T> Flow<T> onCompletion(Flow<? extends T> flow, Function2<? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function2) {
        Intrinsics.checkParameterIsNotNull(flow, "$this$onCompletion");
        Intrinsics.checkParameterIsNotNull(function2, WLConstants.ACTION_ID);
        return FlowKt.onCompletion(flow, (Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object>) new FlowKt__EmittersKt$onCompletion$2<Object,Object,Object,Object>(function2, null));
    }
    ...
    public static final <T, R> Flow<R> unsafeTransform(Flow<? extends T> flow, Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Unit>, ? extends Object> function3) {
        Intrinsics.checkParameterIsNotNull(flow, "$this$unsafeTransform");
        Intrinsics.checkParameterIsNotNull(function3, "transform");
    ...
    public static final <T> Flow<T> onStart(Flow<? extends T> flow, Function2<? super FlowCollector<? super T>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        Intrinsics.checkParameterIsNotNull(flow, "$this$onStart");
        Intrinsics.checkParameterIsNotNull(function2, WLConstants.ACTION_ID);
