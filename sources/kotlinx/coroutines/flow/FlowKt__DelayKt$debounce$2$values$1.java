...
final class FlowKt__DelayKt$debounce$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            FlowCollector flowKt__DelayKt$debounce$2$values$1$invokeSuspend$$inlined$collect$1 = new FlowKt__DelayKt$debounce$2$values$1$invokeSuspend$$inlined$collect$1(producerScope);
            this.L$0 = producerScope;
            this.L$1 = flow;
            this.label = 1;
            if (flow.collect(flowKt__DelayKt$debounce$2$values$1$invokeSuspend$$inlined$collect$1, this) == coroutine_suspended) {
