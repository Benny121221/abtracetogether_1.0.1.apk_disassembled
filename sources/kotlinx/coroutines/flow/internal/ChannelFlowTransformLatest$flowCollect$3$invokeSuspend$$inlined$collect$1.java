...
public final class ChannelFlowTransformLatest$flowCollect$3$invokeSuspend$$inlined$collect$1 implements FlowCollector<T> {
            ...
            if ((r0.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (job != null) {
                        ...
                        r0.L$5 = job;
                        r0.label = 1;
                        if (job.join(r0) == coroutine_suspended) {
    ...
    public ChannelFlowTransformLatest$flowCollect$3$invokeSuspend$$inlined$collect$1(ChannelFlowTransformLatest$flowCollect$3 channelFlowTransformLatest$flowCollect$3, CoroutineScope coroutineScope, ObjectRef objectRef) {
