    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (channel != null) {
                ...
                Flow flow = this.$flow;
                FlowCollector combineKt$asFairChannel$1$invokeSuspend$$inlined$collect$1 = new CombineKt$asFairChannel$1$invokeSuspend$$inlined$collect$1(channelCoroutine);
                this.L$0 = producerScope;
                this.L$1 = channelCoroutine;
                this.L$2 = flow;
                this.label = 1;
                if (flow.collect(combineKt$asFairChannel$1$invokeSuspend$$inlined$collect$1, this) == coroutine_suspended) {
