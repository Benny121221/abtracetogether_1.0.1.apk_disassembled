...
public final class FlowKt__MigrationKt$combine$$inlined$unsafeFlow$3 implements Flow<R> {
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        Intrinsics.needClassReification();
        Intrinsics.needClassReification();
        Function0 flowKt__MigrationKt$combine$$inlined$unsafeFlow$3$lambda$1 = new FlowKt__MigrationKt$combine$$inlined$unsafeFlow$3$lambda$1(this);
        Function3 flowKt__MigrationKt$combine$$inlined$unsafeFlow$3$lambda$2 = new FlowKt__MigrationKt$combine$$inlined$unsafeFlow$3$lambda$2(null, this);
        InlineMarker.mark(0);
