...
public final class FlowKt__DelayKt$sample$2$values$1$invokeSuspend$$inlined$collect$1 implements FlowCollector<T> {
    final /* synthetic */ ProducerScope $this_produce$inlined;

    public FlowKt__DelayKt$sample$2$values$1$invokeSuspend$$inlined$collect$1(ProducerScope producerScope) {
    ...
    public Object emit(Object obj, Continuation continuation) {
        ...
        if (continuation instanceof AnonymousClass1) {
            ...
            if ((r0.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    Object obj5 = r0.L$1;
                    FlowKt__DelayKt$sample$2$values$1$invokeSuspend$$inlined$collect$1 flowKt__DelayKt$sample$2$values$1$invokeSuspend$$inlined$collect$1 = (FlowKt__DelayKt$sample$2$values$1$invokeSuspend$$inlined$collect$1) r0.L$0;
                    ResultKt.throwOnFailure(obj2);
                } else {
        ...
        r0 = new ContinuationImpl(this, continuation) {
            ...
            final /* synthetic */ FlowKt__DelayKt$sample$2$values$1$invokeSuspend$$inlined$collect$1 this$0;
