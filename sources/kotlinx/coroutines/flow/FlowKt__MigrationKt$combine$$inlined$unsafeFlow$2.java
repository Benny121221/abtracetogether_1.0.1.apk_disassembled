...
public final class FlowKt__MigrationKt$combine$$inlined$unsafeFlow$2 implements Flow<R> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        ...
        Intrinsics.needClassReification();
        return CombineKt.combineInternal(flowCollector, flowArr, new FlowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$1(this), new FlowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$2(null, this), continuation);
    }
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        Intrinsics.needClassReification();
        Intrinsics.needClassReification();
        Function0 flowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$1 = new FlowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$1(this);
        Function3 flowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$2 = new FlowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$2(null, this);
        InlineMarker.mark(0);
