...
public final class FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$7 implements Flow<R> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        return this.$this_unsafeTransform$inlined.collect(new FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$7$lambda$1(flowCollector, this), continuation);
    }
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        FlowCollector flowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$7$lambda$1 = new FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$7$lambda$1(flowCollector, this);
        InlineMarker.mark(0);
