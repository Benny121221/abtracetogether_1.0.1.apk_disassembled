...
public final class FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2 implements Flow<R> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        return this.$this_unsafeTransform$inlined.collect(new FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2$lambda$1(flowCollector, this), continuation);
    }
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        FlowCollector flowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2$lambda$1 = new FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2$lambda$1(flowCollector, this);
        InlineMarker.mark(0);
