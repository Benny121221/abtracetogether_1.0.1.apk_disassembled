...
public final class FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$unsafeFlow$1 implements Flow<T> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        ...
        return this.$this_distinctUntilChangedBy$inlined.collect(new FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$unsafeFlow$1$lambda$1(flowCollector, objectRef, this), continuation);
    }
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        FlowCollector flowKt__DistinctKt$distinctUntilChangedBy$$inlined$unsafeFlow$1$lambda$1 = new FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$unsafeFlow$1$lambda$1(flowCollector, objectRef, this);
        InlineMarker.mark(0);
