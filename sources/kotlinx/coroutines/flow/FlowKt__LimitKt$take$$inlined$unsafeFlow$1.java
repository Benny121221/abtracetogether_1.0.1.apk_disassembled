        ...
        if (continuation instanceof AnonymousClass1) {
            ...
            if ((r0.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    FlowCollector flowKt__LimitKt$take$$inlined$unsafeFlow$1$lambda$1 = new FlowKt__LimitKt$take$$inlined$unsafeFlow$1$lambda$1(flowCollector, intRef, this);
                    r0.L$0 = this;
                    ...
                    r0.L$5 = flow;
                    r0.label = 1;
                    if (flow.collect(flowKt__LimitKt$take$$inlined$unsafeFlow$1$lambda$1, r0) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else if (i == 1) {
                    Flow flow2 = (Flow) r0.L$5;
                    IntRef intRef2 = (IntRef) r0.L$4;
