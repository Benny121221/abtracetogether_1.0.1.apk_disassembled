...
final /* synthetic */ class FlowKt__ReduceKt {
        ...
        if (continuation instanceof FlowKt__ReduceKt$reduce$1) {
            ...
            if ((flowKt__ReduceKt$reduce$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    objectRef = (ObjectRef) flowKt__ReduceKt$reduce$1.L$2;
    ...
    /* JADX WARNING: type inference failed for: r5v0, types: [R, T, java.lang.Object] */
    /* JADX WARNING: Incorrect type for immutable var: ssa=R, code=null, for r5v0, types: [R, T, java.lang.Object] */
    /* JADX WARNING: Removed duplicated region for block: B:12:0x0044  */
    /* JADX WARNING: Removed duplicated region for block: B:8:0x0024  */
    /* JADX WARNING: Unknown variable types count: 1 */
    public static final <T, R> Object fold(Flow<? extends T> flow, R r5, Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3, Continuation<? super R> continuation) {
        ...
        if (continuation instanceof FlowKt__ReduceKt$fold$1) {
            ...
            if ((flowKt__ReduceKt$fold$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    flowKt__ReduceKt$fold$1.L$1 = r5;
                    ...
                    objectRef = (ObjectRef) flowKt__ReduceKt$fold$1.L$3;
    ...
    private static final Object fold$$forInline(Flow flow, Object obj, Function3 function3, Continuation continuation) {
        ...
        FlowCollector flowKt__ReduceKt$fold$$inlined$collect$1 = new FlowKt__ReduceKt$fold$$inlined$collect$1(objectRef, function3);
        InlineMarker.mark(0);
        ...
        if (continuation instanceof FlowKt__ReduceKt$single$1) {
            ...
            if ((flowKt__ReduceKt$single$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    ObjectRef objectRef2 = new ObjectRef();
                    objectRef2.element = NullSurrogateKt.NULL;
                    FlowCollector flowKt__ReduceKt$single$$inlined$collect$1 = new FlowKt__ReduceKt$single$$inlined$collect$1(objectRef2);
                    ...
                    objectRef = (ObjectRef) flowKt__ReduceKt$single$1.L$1;
        ...
        if (continuation instanceof FlowKt__ReduceKt$singleOrNull$1) {
            ...
            if ((flowKt__ReduceKt$singleOrNull$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    FlowCollector flowKt__ReduceKt$singleOrNull$$inlined$collect$1 = new FlowKt__ReduceKt$singleOrNull$$inlined$collect$1(objectRef2);
                    ...
                    if (flow.collect(flowKt__ReduceKt$singleOrNull$$inlined$collect$1, flowKt__ReduceKt$singleOrNull$1) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    objectRef = objectRef2;
                } else if (i == 1) {
                    Flow flow2 = (Flow) flowKt__ReduceKt$singleOrNull$1.L$2;
                    objectRef = (ObjectRef) flowKt__ReduceKt$singleOrNull$1.L$1;
        ...
        if (continuation instanceof FlowKt__ReduceKt$first$1) {
            ...
            if ((flowKt__ReduceKt$first$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    objectRef2.element = NullSurrogateKt.NULL;
                    try {
                        FlowCollector flowKt__ReduceKt$first$$inlined$collect$1 = new FlowKt__ReduceKt$first$$inlined$collect$1(objectRef2);
                        ...
                        if (flow.collect(flowKt__ReduceKt$first$$inlined$collect$1, flowKt__ReduceKt$first$1) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    ...
                    objectRef = (ObjectRef) flowKt__ReduceKt$first$1.L$1;
        ...
        if (continuation instanceof FlowKt__ReduceKt$first$3) {
            ...
            if ((flowKt__ReduceKt$first$3.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    objectRef = (ObjectRef) flowKt__ReduceKt$first$3.L$2;
