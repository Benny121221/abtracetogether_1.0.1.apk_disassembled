        ...
        if (continuation instanceof FlowKt__CountKt$count$1) {
            ...
            if ((flowKt__CountKt$count$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    intRef2.element = 0;
                    FlowCollector flowKt__CountKt$count$$inlined$collect$1 = new FlowKt__CountKt$count$$inlined$collect$1(intRef2);
                    ...
                    intRef = (IntRef) flowKt__CountKt$count$1.L$1;
        ...
        if (continuation instanceof FlowKt__CountKt$count$3) {
            ...
            if ((flowKt__CountKt$count$3.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    IntRef intRef2 = new IntRef();
                    intRef2.element = 0;
                    FlowCollector flowKt__CountKt$count$$inlined$collect$2 = new FlowKt__CountKt$count$$inlined$collect$2(function2, intRef2);
                    ...
                    intRef = (IntRef) flowKt__CountKt$count$3.L$2;
