        ...
        if (continuation instanceof FlowKt__CollectionKt$toCollection$1) {
            ...
            if ((flowKt__CollectionKt$toCollection$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    FlowCollector flowKt__CollectionKt$toCollection$$inlined$collect$1 = new FlowKt__CollectionKt$toCollection$$inlined$collect$1(c);
                    ...
                    if (flow.collect(flowKt__CollectionKt$toCollection$$inlined$collect$1, flowKt__CollectionKt$toCollection$1) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else if (i == 1) {
                    Flow flow2 = (Flow) flowKt__CollectionKt$toCollection$1.L$2;
                    c = (Collection) flowKt__CollectionKt$toCollection$1.L$1;
