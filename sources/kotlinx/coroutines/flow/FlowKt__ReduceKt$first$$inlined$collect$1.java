...
public final class FlowKt__ReduceKt$first$$inlined$collect$1 implements FlowCollector<T> {
    final /* synthetic */ ObjectRef $result$inlined;

    public FlowKt__ReduceKt$first$$inlined$collect$1(ObjectRef objectRef) {
