...
public final class FlowKt__ReduceKt$fold$$inlined$collect$2 implements FlowCollector<T> {
    ...
    public Object emit(Object obj, Continuation continuation) {
        ...
        if (continuation instanceof AnonymousClass1) {
            ...
            if ((r0.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    Object obj3 = r0.L$1;
                    FlowKt__ReduceKt$fold$$inlined$collect$2 flowKt__ReduceKt$fold$$inlined$collect$2 = (FlowKt__ReduceKt$fold$$inlined$collect$2) r0.L$0;
                    ResultKt.throwOnFailure(t);
                } else {
        ...
        T t3 = r0.result;
        T coroutine_suspended2 = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        i = r0.label;
        if (i != 0) {
        }
    ...
    public FlowKt__ReduceKt$fold$$inlined$collect$2(ObjectRef objectRef, Function3 function3) {
    ...
    public Object emit$$forInline(Object obj, Continuation continuation) {
        ...
        InlineMarker.mark(5);
        ObjectRef objectRef = this.$accumulator$inlined;
