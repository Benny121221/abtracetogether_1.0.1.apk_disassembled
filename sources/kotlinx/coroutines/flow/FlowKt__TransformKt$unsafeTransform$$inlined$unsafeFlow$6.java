...
public final class FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$6 implements Flow<R> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        return this.$this_unsafeTransform$inlined.collect(new FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$6$lambda$1(flowCollector, this), continuation);
    }
