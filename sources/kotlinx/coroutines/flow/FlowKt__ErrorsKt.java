...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    public static final <T> Flow<T> onErrorCollect(Flow<? extends T> flow, Flow<? extends T> flow2, Function1<? super Throwable, Boolean> function1) {
        ...
        return FlowKt.m990catch(flow, new FlowKt__ErrorsKt$onErrorCollect$2(function1, flow2, null));
    }
        ...
        if (continuation instanceof FlowKt__ErrorsKt$catchImpl$1) {
            ...
            if ((flowKt__ErrorsKt$catchImpl$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    try {
                        FlowCollector flowKt__ErrorsKt$catchImpl$$inlined$collect$1 = new FlowKt__ErrorsKt$catchImpl$$inlined$collect$1(flowCollector, objectRef2);
                    ...
                    objectRef = (ObjectRef) flowKt__ErrorsKt$catchImpl$1.L$2;
    ...
    private static final boolean isSameExceptionAs$FlowKt__ErrorsKt(Throwable th, Throwable th2) {
        return th2 != null && Intrinsics.areEqual((Object) StackTraceRecoveryKt.unwrap(th2), (Object) StackTraceRecoveryKt.unwrap(th));
    }

    /* renamed from: catch reason: not valid java name */
    public static final <T> Flow<T> m991catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
    ...
    public static final <T> Flow<T> retryWhen(Flow<? extends T> flow, Function4<? super FlowCollector<? super T>, ? super Throwable, ? super Long, ? super Continuation<? super Boolean>, ? extends Object> function4) {
        Intrinsics.checkParameterIsNotNull(flow, "$this$retryWhen");
