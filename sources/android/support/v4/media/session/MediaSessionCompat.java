  ...
  mth insns count: 93
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        if (mediaSessionImplApi21 != null) {
                            ...
                            String str2 = MediaSessionCompat.KEY_EXTRA_BINDER;
                            if (extraBinder != null) {
                                r1 = extraBinder.asBinder();
                            }
                            BundleCompat.putBinder(bundle2, str2, r1);
                    ...
                    String str3 = MediaControllerCompat.COMMAND_ARGUMENT_MEDIA_DESCRIPTION;
                    if (equals) {
                        Callback.this.onAddQueueItem((MediaDescriptionCompat) bundle.getParcelable(str3));
                        return;
                    }
                    boolean equals2 = str.equals(MediaControllerCompat.COMMAND_ADD_QUEUE_ITEM_AT);
                    String str4 = MediaControllerCompat.COMMAND_ARGUMENT_INDEX;
                    if (equals2) {
                        Callback.this.onAddQueueItem((MediaDescriptionCompat) bundle.getParcelable(str3), bundle.getInt(str4));
                    } else if (str.equals(MediaControllerCompat.COMMAND_REMOVE_QUEUE_ITEM)) {
                        Callback.this.onRemoveQueueItem((MediaDescriptionCompat) bundle.getParcelable(str3));
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        public MetadataEditor buildRccMetadata(Bundle bundle) {
            ...
            String str13 = MediaMetadataCompat.METADATA_KEY_TITLE;
            if (bundle.containsKey(str13)) {
                editMetadata.putString(7, bundle.getString(str13));
            }
            String str14 = MediaMetadataCompat.METADATA_KEY_TRACK_NUMBER;
            if (bundle.containsKey(str14)) {
                editMetadata.putLong(0, bundle.getLong(str14));
            }
            String str15 = MediaMetadataCompat.METADATA_KEY_WRITER;
            if (bundle.containsKey(str15)) {
                editMetadata.putString(11, bundle.getString(str15));
            }
            return editMetadata;
        }
    ...
    public static final class QueueItem implements Parcelable {
        ...
        public Object getQueueItem() {
            ...
            Object createItem = QueueItem.createItem(this.mDescription.getMediaDescription(), this.mId);
